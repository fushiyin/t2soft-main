...
function generateDocuments(count = 30) {
	...
	for (let i = 0; i < count; i++) {
		...
		const fileName = `${title.toLowerCase().replace(/\s+/g, "_").replace(/[^a-z0-9_]/g, "")}.${docType.ext}`;
...
const sampleDocuments = [
	{
		...
		description: "The original Bitcoin whitepaper by Satoshi Nakamoto explaining the concept of a decentralized digital currency.",
		category: "Crypto",
		fileName: "bitcoin_whitepaper.pdf",
		fileUrl: "https://storage.googleapis.com/trading-76356.appspot.com/documents/bitcoin-whitepaper/bitcoin_whitepaper.pdf",
	...
	},
	{
		...
		description: "Comprehensive guide to Decentralized Finance protocols, yield farming strategies, and risk management in DeFi.",
		category: "DeFi",
		fileName: "defi_complete_guide_2024.pdf",
		fileUrl: "https://storage.googleapis.com/trading-76356.appspot.com/documents/defi-guide-2024/defi_complete_guide_2024.pdf",
		mimeType: "application/pdf",
		fileSize: 2458624,
		downloadCount: 890,
		isPublic: true,
	...
	},
	{
		...
		description: "Excel spreadsheet with formulas for calculating risk/reward ratios, position sizing, and technical indicators.",
		category: "Trading",
		fileName: "trading_strategies_calculator.xlsx",
		fileUrl: "https://storage.googleapis.com/trading-76356.appspot.com/documents/trading-strategies-excel/trading_strategies_calculator.xlsx",
	...
	},
	{
		...
		description: "Detailed analysis of NFT market trends, top collections performance, and future predictions for the digital collectibles space.",
		category: "NFT",
		fileName: "nft_market_analysis_q4_2024.pptx",
		fileUrl: "https://storage.googleapis.com/trading-76356.appspot.com/documents/nft-market-analysis/nft_market_analysis_q4_2024.pptx",
	...
	},
	{
		...
		description: "Essential compliance requirements for cryptocurrency trading platforms and individual traders in various jurisdictions.",
		category: "Legal",
		fileName: "crypto_compliance_checklist.docx",
		fileUrl: "https://storage.googleapis.com/trading-76356.appspot.com/documents/compliance-checklist/crypto_compliance_checklist.docx",
