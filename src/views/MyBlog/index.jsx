...
const Blog = () => {
  ...
  const articles = [
    {
      ...
      excerpt: "Learn the fundamental strategies that every new forex trader should master to start their journey successfully.",
    ...
    },
    {
      ...
      excerpt: "Discover how Bitcoin market cycles work and how to use this knowledge to make better trading decisions.",
    ...
    },
    {
      ...
      excerpt: "Master the art of risk management to protect your capital and ensure sustainable trading profits.",
    ...
    },
    {
      ...
      excerpt: "Explore the most reliable chart patterns and how to use them effectively in your trading strategy.",
    ...
    },
    {
      ...
      excerpt: "Understanding decentralized finance and its impact on cryptocurrency trading opportunities.",
      image: "https://images.pexels.com/photos/844124/pexels-photo-844124.jpeg?auto=compress&cs=tinysrgb&w=400",
    ...
    },
    {
      ...
      excerpt: "Learn how market psychology affects price movements and how to use this knowledge to your advantage.",
  ...
  const getCategoryColor = (category) => {
    switch (category) {
      ...
      case 'Market News': return 'bg-red-100 text-red-800';
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Stay updated with the latest trading insights, market analysis, and educational content
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredArticles.slice(1).map((article) => (
            <div key={article.id} className="bg-gray-800 rounded-2xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 border border-gray-700">
              <img
                src={article.image}
                alt={article.title}
